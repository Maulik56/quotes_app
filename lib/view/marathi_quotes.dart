...
import 'package:quotes_app/quotes_category/marathi.dart';
import 'package:screenshot/screenshot.dart';
import 'package:share/share.dart';

class MarathiQuotes extends StatefulWidget {
  const MarathiQuotes({Key? key}) : super(key: key);

  @override
  _MarathiQuotesState createState() => _MarathiQuotesState();
}

class _MarathiQuotesState extends State<MarathiQuotes> {
  Uint8List? bytes;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= marathiQuotes.length; i = i + 5) {
      ...
      body: Theme(
        ...
        child: Scrollbar(
          child: ListView.builder(
            itemCount: marathiQuotes.length,
