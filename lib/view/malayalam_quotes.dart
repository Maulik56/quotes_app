...
import 'package:quotes_app/quotes_category/malayalam.dart';
import 'package:screenshot/screenshot.dart';
import 'package:share/share.dart';

class MalayalamQuotes extends StatefulWidget {
  const MalayalamQuotes({Key? key}) : super(key: key);

  @override
  _MalayalamQuotesState createState() => _MalayalamQuotesState();
}

class _MalayalamQuotesState extends State<MalayalamQuotes> {
  Uint8List? bytes;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= malayalamQuotes.length; i = i + 5) {
