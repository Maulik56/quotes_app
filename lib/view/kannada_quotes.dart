...
import 'package:quotes_app/quotes_category/kannad.dart';
import 'package:screenshot/screenshot.dart';
import 'package:share/share.dart';

class KannadaQuotes extends StatefulWidget {
  const KannadaQuotes({Key? key}) : super(key: key);

  @override
  _KannadaQuotesState createState() => _KannadaQuotesState();
}

class _KannadaQuotesState extends State<KannadaQuotes> {
  Uint8List? bytes;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= kannadaQuotes.length; i = i + 5) {
