...
class HindiQuotes extends StatefulWidget {
  const HindiQuotes({Key? key}) : super(key: key);

  @override
  _HindiQuotesState createState() => _HindiQuotesState();
}

class _HindiQuotesState extends State<HindiQuotes> {
  Uint8List? bytes;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= hindiQuotes.length; i = i + 5) {
