...
import 'package:quotes_app/quotes_category/tamil.dart';
import 'package:screenshot/screenshot.dart';
import 'package:share/share.dart';

class TamilQuotes extends StatefulWidget {
  const TamilQuotes({Key? key}) : super(key: key);

  @override
  _TamilQuotesState createState() => _TamilQuotesState();
}

class _TamilQuotesState extends State<TamilQuotes> {
  Uint8List? bytes;
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i <= tamilQuotes.length; i = i + 5) {
